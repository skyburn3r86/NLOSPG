...
function [model, materials, comsol_parameters] = ModelSetup_Parameters(param_list, para_list_index, varargin)
    ...
    comsol_parameters = struct(...
        ...
        'l1SiO2', {0.11624, '[um]'}, ...
        'l2SiO2', {9.8961, '[um]'}, ...
        'vaccum_capacitance', {'(eps0*hMetal*lWG/wMetal)',''},...
	...
	materials = struct(...
		...
		'MetalRoughMesh_1', 'nk_Au_IEF_1604.txt',...
		'MetalFineMesh_1', 'nk_Au_IEF_1604.txt',...
		'MetalRoughMesh_2', 'nk_Au_IEF_1604.txt',...
		'MetalFineMesh_2', 'nk_Au_IEF_1604.txt',...
	...
	% I) Analytic (sellmaier, lorentz, drude etc,) defined by model
	% parameters example given here for graphene
