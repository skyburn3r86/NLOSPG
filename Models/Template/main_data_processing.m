...
plotResultList(sim_results, param_list,'data_str', 'g_0',...
    'para_str', {'hOEO', 'hWG' ,'wl', 'wWG'}, 'para_value', {[], 300e-9 , [], []},...
    'para_unit', {'[m]', '[m]' , '[m]'},'position', size_figure,...
    'data_FOM', 'max', 'save', [save_folder '/']);

plotResultList(sim_results, param_list,'data_str', 'Q',...
    'para_str', {para_sweep{1}.str, 'hWG' ,'wl', 'wWG'}, 'para_value', {[], 300e-9 ,[], []},...
    'para_unit', {'[m]', '[m]' , '[m]'},'position', size_figure,...
    'data_FOM', 'max', 'save', [save_folder '/']);
