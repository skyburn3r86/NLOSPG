...
plotResultList(sim_results, param_list,'data_str', 'g_0',...
    'para_str', {para_sweep{1}.str, 'hWG_bot' ,'wl', 'wWG'}, 'para_values', {[], [] ,1900e-9, 300e-9},...
    'data_FOM', 'max', 'save', ['./Results/' save_str '\']);

plotResultList(sim_results, param_list,'data_str', 'g_0',...
    'para_str', {para_sweep{1}.str, 'hWG_bot' ,'wl', 'wWG'}, 'para_values', {[], [] ,1900e-9, 600e-9},...
    'data_FOM', 'max', 'save', ['./Results/' save_str '\']);

plotResultList(sim_results, param_list,'data_str', 'g_0',...
    'para_str', {para_sweep{1}.str, 'hWG_bot' ,'wl', 'wWG'}, 'para_values', {[], [] ,1900e-9, 900e-9},...
    'data_FOM', 'max', 'save', ['./Results/' save_str '\']);
