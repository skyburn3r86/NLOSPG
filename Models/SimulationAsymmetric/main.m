...
para_sweep{3}.values = linspace(100, 200, (200-50)/100 + 1)*1e-9;
para_sweep{3}.str = 'hOEO';
para_sweep{3}.unit = '[m]';
para_sweep{2}.values = linspace(0.2, 0.45, (0.45-0.2)/0.05 + 1); 
para_sweep{2}.str = 'r';
para_sweep{2}.unit = '';
para_sweep{1}.values = linspace(800, 1200, (1200-800)/100 + 1)*1e-9;
